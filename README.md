# mathParser
Worker information
hostname: i-081413a-production-2-worker-org-ec2.travisci.net:bcfa1779-e5d6-47a0-beae-e193fb24c7ce
version: v2.9.3 https://github.com/travis-ci/worker/tree/a41c772c638071fbbdbc106f31a664c0532e0c36
instance: f302292:travis:node_js (via amqp)
startup: 693.285104ms
system_info
...
git.checkout
0.55s$ git clone --depth=50 --branch=master https://github.com/rslyshynskyi/mathParser.git rslyshynskyi/mathParser
Cloning into 'rslyshynskyi/mathParser'...
remote: Counting objects: 381, done.
remote: Compressing objects: 100% (286/286), done.
remote: Total 381 (delta 69), reused 379 (delta 67), pack-reused 0
Receiving objects: 100% (381/381), 518.11 KiB | 0 bytes/s, done.
Resolving deltas: 100% (69/69), done.
$ cd rslyshynskyi/mathParser
$ git checkout -qf 17ebd72f959574526e57970a16fa6298435c7768
$ export PATH=./node_modules/.bin:$PATH
Updating nvm
nvm.install
7.05s$ nvm install stable
...
npm WARN mathparser@1.0.0 No repository field.
removed 40 packages in 0.644s
1.36s$ npm ls
mathparser@1.0.0 /home/travis/build/rslyshynskyi/mathParser
└── (empty)
before_script.1
1.19s$ npm install
npm WARN mathparser@1.0.0 No repository field.
...
before_script.2
7.02s$ npm install mocha
npm WARN mathparser@1.0.0 No repository field.
+ mocha@3.5.0
added 34 packages in 5.744s
before_script.3
4.14s$ npm install should
npm WARN mathparser@1.0.0 No repository field.
+ should@13.0.1
added 6 packages in 2.863s
before_script.4
2.07s$ npm test
